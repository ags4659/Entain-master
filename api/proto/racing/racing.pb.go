...
type ListRacesRequest struct {
	...
	Filter     *ListRacesRequest_Filter `protobuf:"bytes,2,opt,name=filter,proto3" json:"filter,omitempty"`
	// Add a field to specify the sort order
...
func (x *ListRacesRequest) GetMeetingIds() []int64 {
	if x != nil {
		return x.MeetingIds
	}
	return nil
...
func (x *ListRacesRequest) GetFilter() *ListRacesRequest_Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *ListRacesRequest) GetSortBy() string {
	if x != nil {
		return x.SortBy
	}
	return ""
...
func (x *ListRacesRequest) GetAscending() bool {
	if x != nil {
		return x.Ascending
	}
	return false
...
type GetRaceRequest struct {
	...
	// ID represents the unique identifier for the race.
...
type Race struct {
	...
	// Status represents the current status of the race (OPEN/CLOSED).
...
type ListRacesRequest_Filter struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListRacesRequest_Filter) Reset() {
	*x = ListRacesRequest_Filter{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListRacesRequest_Filter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRacesRequest_Filter) ProtoMessage() {}

func (x *ListRacesRequest_Filter) ProtoReflect() protoreflect.Message {
	mi := &file_racing_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRacesRequest_Filter.ProtoReflect.Descriptor instead.
func (*ListRacesRequest_Filter) Descriptor() ([]byte, []int) {
	return file_racing_proto_rawDescGZIP(), []int{0, 0}
}

func (x *ListRacesRequest_Filter) GetVisibleOnly() bool {
	if x != nil {
...
var file_racing_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd0, 0x01, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61,
	0x63, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x65,
	0x65, 0x74, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52,
	0x0a, 0x6d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x73, 0x12, 0x37, 0x0a, 0x06, 0x66,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x72, 0x61,
	...
	0x6c, 0x74, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x62, 0x79, 0x18,
	...
	0x52, 0x09, 0x61, 0x73, 0x63, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x1a, 0x2b, 0x0a, 0x06, 0x46,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x76, 0x69, 0x73, 0x69, 0x62, 0x6c, 0x65,
	0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x76, 0x69, 0x73,
	0x69, 0x62, 0x6c, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x22, 0x37, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xbc,
	...
	0x2d, 0x72, 0x61, 0x63, 0x65, 0x73, 0x12, 0x55, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x52, 0x61, 0x63,
	...
	0x67, 0x65, 0x74, 0x2d, 0x72, 0x61, 0x63, 0x65, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0x09, 0x5a,
...
var file_racing_proto_goTypes = []interface{}{
	...
	(*ListRacesRequest_Filter)(nil), // 5: racing.ListRacesRequest.Filter
	(*timestamppb.Timestamp)(nil),   // 6: google.protobuf.Timestamp
}
var file_racing_proto_depIdxs = []int32{
	5, // 0: racing.ListRacesRequest.filter:type_name -> racing.ListRacesRequest.Filter
	4, // 1: racing.ListRacesResponse.races:type_name -> racing.Race
	4, // 2: racing.GetRaceResponse.race:type_name -> racing.Race
...
func file_racing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_racing_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListRacesRequest_Filter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
